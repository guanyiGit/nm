...
//                     }
//                 }
//                 $('#exampleTablee').bootstrapTable('refresh', opt);
//             });
//         }
//     });
// }
function load() {
    // selectLoad();
    $('#exampleTablee').bootstrapTable(
            {
                method : 'get', // 服务器数据的请求方式 get or post
                url : prefix+"/findCooperationList", // 服务器数据的加载地址
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
                iconSize : 'outline',
...
function check(id) {
	window.location="/biz/cooperation/findCooperationDetail?id="+id+"";
    /*layer.open({
        type : 2,
        title : '查看',
        maxmin : true,
 ...
 function edit(id) {
	 window.location="/biz/cooperation/cooperation_Update?id="+id+"";
    /* layer.open({
         type : 2,
         title : '编辑',
         maxmin : true,
...
//     var rows = $('#exampleTablee').bootstrapTable('getSelections'); // 返回所有选择的行，当没有选择的记录时，返回一个空数组
//     if (rows.length == 0) {
//         layer.msg("请选择要删除的数据");
//         return;
//     }
