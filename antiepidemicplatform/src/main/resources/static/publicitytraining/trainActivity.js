        ...
        .bootstrapTable(
            {
                ...
                columns : [
                    ...
                    },
                    {
                        ...
                        align : 'center',
                        formatter : function(value, row, index) {
                            var f = '<a class="btn btn-success btn-sm" href = "'+prefix+'/trainDetail/'+row.id+'" target="menuFrame" title="查看">'+checkk+'</a>';
                            var e = '<a class="btn btn-info btn-sm" href = "'+prefix+'/editTrainActivity/'+row.id+'" target="menuFrame" title="修改">'+updatee+'</a>';
