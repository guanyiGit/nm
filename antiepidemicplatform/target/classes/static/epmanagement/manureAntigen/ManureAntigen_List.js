var prefix = "/biz/manureAntigen";
var url="/findManureAntigenList";
var orgId=null;
var user=user;
$(function() {
	//初始化组织下拉框(州级和县级)
...
function check(id) {
	window.location="/biz/manureAntigen/getManureAntigenDetail?id="+id+"";
//    layer.open({
//        type : 2,
//        title : '查看',
//        maxmin : true,
...
//跳转到修改页面
 function edit(id) {
	 window.location="/biz/manureAntigen/edit?id="+id+"";
//     layer.open({
//         type : 2,
//         title : '编辑',
//         maxmin : true,
