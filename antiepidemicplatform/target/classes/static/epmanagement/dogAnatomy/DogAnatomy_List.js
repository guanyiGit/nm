var prefix = "/biz/dogAnatomy";
var url="/findDogAnatomyList";
var orgId=null;
var user=user;
$(function() {
	//初始化组织下拉框(州级和县级)
...
//                    	searchKey : $('#searchKey').val()
                ...
                columns : [
                    ...
                    {
                        field : 'positiveAmount',
                        title : positiveCount5,
                        width : '100px',
                        align: 'center'
                    },
                    {
...
function check(id) {
	window.location="/biz/dogAnatomy/getDogAnatomyDetail?id="+id+"";
//    layer.open({
//        type : 2,
//        title : '查看',
//        maxmin : true,
...
//跳转到修改页面
 function edit(id) {
	 window.location="/biz/dogAnatomy/edit?id="+id+"";
//     layer.open({
//         type : 2,
//         title : '编辑',
//         maxmin : true,
