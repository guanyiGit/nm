...
var prefix = "/biz/pastoralCommittee";
var orgId=1;
$(function() {
	//获取登录用户信息,待完善
	//var user=
        ...
        .bootstrapTable(
            {
                ...
                url : prefix+"/findPasoralCommitteeList", // 服务器数据的加载地址
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
                iconSize : 'outline',
...
function check(id) {
	window.location="/biz/pastoralCommittee/findPastoralCommitteeDetail?id="+id+"";
//    layer.open({
//        type : 2,
//        title : '查看',
//        maxmin : true,
...
//    });
 ...
 function edit(id) {
	window.location="/biz/pastoralCommittee/pastoral_Update?id="+id+"";
//     layer.open({
//         type : 2,
//         title : '编辑',
//         maxmin : true,
