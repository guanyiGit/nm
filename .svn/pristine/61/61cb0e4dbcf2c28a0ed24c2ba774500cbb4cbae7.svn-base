var prefix = "/biz/infectionInfo";
var url="/findInfectionInfoList";
var user=user;
$(function() {
	//初始化组织下拉框(州级和县级)
	initOrgSelect();
...
//                    	searchKey : $('#searchKey').val()
                ...
                columns : [
                    ...
                    {
                        field : 'detectionAmount',
                        title : surveyNum,
                        width : '100px',
                        align: 'center'
                    },
                    {
                        field : 'infectionAmount',
                        title : infectionNum,
                        width : '100px',
                        align: 'center'
                    },
                    ...
                    {
                        field : 'harmlessTreatAmount',
                        title : harmlessTreatNum,
                        align: 'center'
                    },
                    {
                        field : 'detectionDate',
...
function check(id) {
	window.location="/biz/infectionInfo/getInfectionInfoDetail?id="+id+"";
//    layer.open({
//        type : 2,
//        title : '查看',
//        maxmin : true,
...
//跳转到修改页面
 function edit(id) {
	 window.location="/biz/infectionInfo/toInfectionInfo_Update?id="+id+"";
//     layer.open({
//         type : 2,
//         title : '编辑',
//         maxmin : true,
