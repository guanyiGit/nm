...
var prefix = "/biz/comprehensiveReport"
$(function() {
    laydate.render({
        elem: '#year', //指定元素
        type:"year"
        ...
        .bootstrapTable(
            {
                ...
                url : prefix+"/monthList", // 服务器数据的加载地址
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
                iconSize : 'outline',
                    ...
                    },
                    {
                        ...
                        formatter : function(value, row, index) {
                            /*var f = '<a class="btn btn-primary btn-sm" href="#" mce_href="#" title="查看" onclick="detail(\''
                                + row.perMonth
                                + '\')"><i class="fa"></i>查看</a> ';*/
                            var f = '<a class="btn btn-primary btn-sm" href = "'+prefix+'/detail/'+row.perMonth+'" target="menuFrame" title="查看"><i class="fa"></i>'+check+'</a>';
                            var e = '<a class="btn btn-success btn-sm" href="#" mce_href="#" title="导出" onclick="edit(\''
                                + row.perMonth
                                + '\')"><i class="fa"></i>'+exportt+'</a> ';
                            // return f+e;
                            return f;
                        }
                    } ]
...
//         area : [ '100%', '100%' ],
//         content : prefix + '/detail/' + perMonth // iframe的url
//     });
// }
// function edit(id) {
//     layer.open({
