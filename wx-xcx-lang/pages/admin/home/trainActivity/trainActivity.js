...
Page({
  ...
  onLoad: function (options) {
    wx.setNavigationBarTitle({ title: wx.T.get("peixunhuodong") })
    //主题
    this.data.component.placeholderText = wx.T.get("zhuti");
    this.setData({
  ...
  toActivityAddPage() {
    wx.navigateTo({
      url: '/pages/admin/home/trainActivity/add/add',
    })
  },
  toActivityInfoPage(e) {
    ...
    wx.navigateTo({
      url: '/pages/admin/home/trainActivity/info/info?id=' + id,
    })
  }
