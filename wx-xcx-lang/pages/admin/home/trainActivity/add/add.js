...
Page({
  ...
  onLoad: function (options) {
    wx.setNavigationBarTitle({ title: wx.T.get("xinzengpeixunhuodong") })
  ...
  initValidate: function () {
    ...
    var messages = {
      ...
      participateAmount: {
        required: wx.T.get("qingtianxiecanyurenshu"),
        digits: wx.T.get("canshurenshutianxiebuzhengque"),
      },
      activityContent: {
        required: wx.T.get("qingtianxieneirong"),
      },
      activityTarget: {
        required: wx.T.get("qingtianxiepeixunduixiang"),
      }
    };
