...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.setNavigationBarTitle({
      title: wx.T.get("xinzengfanghuwuzi")
    })
  ...
  initValidate: function () {
    ...
    var messages = {
      goodsName: {
        required: wx.T.get("qingtianxiewuzimingcheng"),
      },
      goodsAmount: {
        required: wx.T.get("qingtianxiefafangshuliang"),
        digits: wx.T.get("shuliangtianxiebuzhengque"),
      },
    };
