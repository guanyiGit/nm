...
Page({
  ...
  toOwnerPage(e) {
    ...
    wx.navigateTo({
      url: '/pages/home/ownerInfo/info/info?ownerInfo_index=' + ownerInfo_index,
    })
  },
  ...
  onLoad: function(options) {
    this.data.component.placeholderText = wx.T.get("xingming") + "/" +
      wx.T.get("dianhuahaoma");
    this.setData({
      component: this.data.component
    })
    wx.setNavigationBarTitle({ title: wx.T.get("quanzhu_xinxi") })
