...
class WxValidate {
  ...
  __initDefaults() {
    ...
    // this.defaults = {
    //   required: L.get("zheshibitianziduan"),
    //   email: L.get("qingshuruyouxiaodedianziyoujiandizhi"),
    //   tel: L.get("qingshuru11weishoujihao"),
    //   url: L.get("qingshuruyouxiaodewangzhi"),
    //   date: L.get("qingshuruyouxiaoriqi"),
    //   dateISO: L.get("qingshuruyouxiaoriqi") + "（ISO）" + "," + L.get("liru") + ":2009-06-23，1998/01/22",
    //   number: L.get("qingshuruyouxiaoshuzi"),
    //   digits: L.get("zhinengshurushuzi"),
    //   idcard: L.get("qingshuru18weiyouxiaozhenghao"),
    //   equalTo: this.formatTpl(L.get("shuruzhibixudengyu") + ' {0}。'),
    //   contains: this.formatTpl(L.get("shuruzhibixubaohan") + ' {0}。'),
    //   minlength: this.formatTpl(L.get("shuruzuixiaochangduwei") + ' {0} ' + L.get("gezifu") + '。'),
    //   maxlength: this.formatTpl(L.get("shuruzuidachangduwei") + ' {0} ' + L.get("gezifu") + '。'),
    //   rangelength: this.formatTpl(L.get("shuruchangdubixuwei") + ' [ {0}-{1}] '),
    //   min: this.formatTpl(L.get("qingshurubuxiaoyu") + ' {0} 。'),
    //   max: this.formatTpl(L.get("qingshurubudayu") + ' {0} 。'),
    //   range: this.formatTpl(L.get("shurufanweizai") + ' [{0}-{1}] 。'),
    // }
  }
